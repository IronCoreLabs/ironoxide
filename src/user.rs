...
///     that requires that users be generated prior to the user logging in for the first time. In this situation, a user's
///     cryptographic identity can be generated by a third party, like a server process, and then the user can take control of their
///     keys by rotating their private key using [`user_rotate_private_key`](trait.UserOps.html#tymethod.user_rotate_private_key).
#[async_trait]
pub trait UserOps {
    /// Creates a user.
    ///
